...
# Copyright (C) 2014-2015 The CMREmixRom Project
#
...
# example fetch="https://github.com/CMRemixRom"
default_team_rem = "cmremix"
# this shouldn't change unless google makes changes
local_manifest_dir = ".repo/local_manifests"
# change this to your name on github (or equivalent hosting)
android_team = "CMRemixRom"
...
def fetch_dependencies(device):
    location = "vendor/cmremix/dependencies/"
...
if __name__ == '__main__':
    ...
    if not os.path.isfile("vendor/cmremix/dependencies/" + device + ".dependencies"):
