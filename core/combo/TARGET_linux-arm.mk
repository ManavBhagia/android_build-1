...
$(combo_2nd_arch_prefix)TARGET_GCC_VERSION := $(TARGET_GCC_VERSION_AND)
endif

ifeq ($(strip $(TARGET_GCC_VERSION_ARM)),)
$(combo_2nd_arch_prefix)TARGET_GCC_VERSION_ARM := 4.9
else
$(combo_2nd_arch_prefix)TARGET_GCC_VERSION_ARM := $(TARGET_GCC_VERSION_ARM)
endif
...
ifneq ($(filter 4.6 4.6.% 4.7 4.7.% 4.8 4.9 4.9.%, $($(combo_2nd_arch_prefix)TARGET_GCC_VERSION_AND)),)
ifneq ($(filter 4.6 4.6.% 4.7 4.7.% 4.8 4.9 4.9.%, $($(combo_2nd_arch_prefix)TARGET_GCC_VERSION_ARM)),)
